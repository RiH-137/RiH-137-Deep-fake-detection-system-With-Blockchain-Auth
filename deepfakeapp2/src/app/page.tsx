...
function App() {
  return (
    <><div className="App MainContainer w-full">
    {/* Video background */}
    <div className="video-background">
      {/* <video autoPlay loop muted>
        <source src="./3406592077-preview.mp4" type="video/mp4"  />
    ...
    <div className="div flex justify-center focus:contain-style " id="home">
      <div className='w-[50%]'>
     ...
     <br />
     <button className="glow-on-hover shadow-lg" type="button" onClick={()=>{
      Redirect("/p-2-p")
     }}>Try Now</button>
      </div>
      </div>
   </div>
   <div className="features" id="key-benefits">
...
Large and Diverse Datasets: High accuracy is achieved through training on large and diverse datasets that include a wide range of facial images. Datasets like the Wider Face, LFW (Labeled Faces in the Wild), and VGGFace provide extensive and varied samples, helping the model generalize better to different conditions.
    ...
    <div className="div1">
      ...
      <div className="img"><img id='feature2' src="./download.png" alt="img" /></div>
      <div className="text">
...
<button className="glow-on-hover1" type="button" onClick={()=>{
      Redirect("/p-2-p")
     }}>Upload Here</button>
